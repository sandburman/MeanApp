...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__guards_auth_guard__ = __webpack_require__(514);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_profile_profile_component__ = __webpack_require__(512);
    ...
    LoginComponent.prototype.onSubmitLogin = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show('You are logged in', { cssClass: 'alert-success', timeout: 5000 });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onSubmitRegister = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('User successfully registered', { cssClass: 'alert-success' });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('An error has occurred', { cssClass: 'alert-danger' });
